...
const VerifyToken_1 = require("./dto/VerifyToken");
...
let AuthController = class AuthController {
    ...
    async login({ login, password }, res) {
        ...
        res.cookie('token', await this.authService.createToken(login)).send((0, responseMessage_1.default)(false, 'OK', userCopy));
    }
    async verifyToken({ token: tokenBody }, req, res) {
        ...
        try {
            ...
            const userCopy = JSON.parse(JSON.stringify(user));
            delete userCopy.password;
            res.send((0, responseMessage_1.default)(false, 'OK', userCopy));
        }
        catch (e) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Login_1.default, Object]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [VerifyToken_1.default, Object, Object]),
    __metadata("design:returntype", Promise)
